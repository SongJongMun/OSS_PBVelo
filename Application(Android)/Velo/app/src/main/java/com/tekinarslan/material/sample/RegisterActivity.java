...
public class RegisterActivity extends Activity {
    ...
    private android.widget.Button btnLinkToLogin;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister = (android.widget.Button) findViewById(R.id.btnRegister);
        btnLinkToLogin = (android.widget.Button) findViewById(R.id.btnLinkToLoginScreen);
    ...
    private void registerUser( final String name, final String id,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name, id, uid, created_at);
